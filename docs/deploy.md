...
4. In [Review deployments](https://docs.github.com/en/actions/managing-workflow-runs/reviewing-deployments#approving-or-rejecting-a-job), choose the job environment(s) (`prod` or `test`) to approve deployment
